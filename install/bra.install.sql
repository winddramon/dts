...
CREATE TABLE `bra_users` (
  ...
  `lastgame` char(10) NOT NULL DEFAULT '',
  `validgames` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `wingames` mediumint(8) unsigned NOT NULL DEFAULT '0',  
  ...
  `u_settings` text NOT NULL DEFAULT '',
