...
function bubblebox_start($str)
{
	...
	$bbox_positioner_inner_margin_top = $bbox_offset_y-ceil(($bbox_height+$bbox_border_width_y*2+$bbox_margin_top+$bbox_margin_bottom)/2);
	$bbox_positioner_inner_margin_left = $bbox_offset_x-ceil(($bbox_width+$bbox_border_width_x*2+$bbox_margin_left+$bbox_margin_right)/2);
	$bbox_positioner_inner_min_width = $bbox_width+$bbox_border_width_x*2+$bbox_margin_left+$bbox_margin_right;
	$bbox_positioner_inner_max_width = $bbox_width+$bbox_border_width_x*2+$bbox_margin_left+$bbox_margin_right;
	$bbox_positioner_inner_min_height = $bbox_height+$bbox_border_width_y*2+$bbox_margin_top+$bbox_margin_bottom;
	$bbox_positioner_inner_max_height = $bbox_height+$bbox_border_width_y*2+$bbox_margin_top+$bbox_margin_bottom;
	$bbox_screen_fader_inner_margin_top = $bbox_offset_y-ceil(($bbox_height+$bbox_margin_top+$bbox_margin_bottom)/2);
	$bbox_screen_fader_inner_margin_left = $bbox_offset_x-ceil(($bbox_width+$bbox_margin_left+$bbox_margin_right)/2);
	$bbox_screen_fader_inner_min_width = $bbox_width+$bbox_margin_left+$bbox_margin_right;
	$bbox_screen_fader_inner_max_width = $bbox_width+$bbox_margin_left+$bbox_margin_right;
	$bbox_screen_fader_inner_min_height = $bbox_height+$bbox_margin_top+$bbox_margin_bottom;
	$bbox_screen_fader_inner_max_height = $bbox_height+$bbox_margin_top+$bbox_margin_bottom;
