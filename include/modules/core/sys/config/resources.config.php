...
namespace sys
{
	...
	$gtinfo=array(
		...
		22=>'<font class="seagreen">梦境演练</font>',
	);
	$gtdesc=array(
		0=>'不能使用卡片',
		4=>'入场时自选一张卡片',
	...
	$dinfo = Array(
		...
		33 => '“对不起、对不起！能让我迫降一下吗？”<br>勉强躲过弹幕的你，忽然听到头上传来这样焦急的道歉声。<br>少女的迫降……？莫非是指……<br>少女娇柔的话音让你放松了警惕。<br>还没等你反应过来，少女——<br>——以及她乘坐的、几十吨重的机体——<br>——便把你的整个世界压得粉碎……<br>',
	...
	$chatinfo = Array(0 => '全员', 1 => '队伍', 2 => '密语', 3 => '遗言', 4 => '公告', 5 => '系统', 6 => '对话', 7 => '弹幕');
	
	$chatclass = Array(0 => '', 1 => 'cyan', 2 => '', 3 => 'red', 4 => 'yellow', 5 => 'yellow', 6 => 'seagreen', 7 => 'grey');
