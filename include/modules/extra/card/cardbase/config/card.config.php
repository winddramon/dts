...
<br>￣^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^￣
	...
	1202 => array(
		...
		'effect' => '称号固定为走路萌物，<br>初始攻防小幅增加，没有技能「治愈」<br>（成就计分×2）',
		'desc_skills' => '初始攻防+100',
		'energy' => 0,
		'valid' => array(
			'club' => '17',
			'att' => '+100',
	...
	1203 => array(
		...
		'pack' => 'Pungeon',
		'desc' => '困难难度。<br>加班受害者。',
		'effect' => '称号固定为走路萌物，<br>没有技能「治愈」，<br>使用补给效果和造成伤害降低<br>（成就计分×4）',
		'desc_skills' => '食用补给效果-30%，造成伤害-20%',
		'energy' => 0,
		'valid' => array(
			'club' => '17',
			'skills' => array(
	...
	1204 => array(
		...
		'effect' => '称号固定为走路萌物，<br>没有技能「治愈」和「解限」，<br>使用补给效果和造成伤害降低，<br>获得金钱和初始道具减少<br>（成就计分×8）',
		'desc_skills' => '食用补给效果-30%，造成伤害-30%，获得金钱-50%<br>没有初始技能核心和补给品外的初始道具',
		'energy' => 0,
		'valid' => array(
			'club' => '17',
			'skills' => array(
