...
<br>￣^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^￣
	...
	1203 => array(
		...
		'pack' => 'Pungeon',
		'desc' => '困难难度。<br>加班受害者。',
		'effect' => '称号固定为走路萌物，<br>没有技能「治愈」，<br>使用补给效果降低，商店价格×1.5<br>（成就计分×4）',
	...
	1204 => array(
		...
		'rare' => 'S',
		'pack' => 'Pungeon',
		'desc' => '疯狂难度。<br><span class="red b">烫烫烫烫烫烫烫</span>',
		'effect' => '称号固定为走路萌物，<br>没有技能「治愈」和「解限」，<br>使用补给效果和造成伤害降低，<br>商店价格翻倍，初始道具减少<br>（成就计分×8）',
		'desc_skills' => '使用补给效果-30%，造成伤害-20%<br>没有补给品外的初始道具<br>没有初始技能核心',
		'energy' => 0,
		'valid' => array(
			'club' => '17',
			'skills' => array(
