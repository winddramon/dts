...
<br>￣^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^￣
	...
	426 => array(
		...
		'valid' => array(
			...
			'itme3' => '1',
			'itms3' => '1',
			'itmsk3' => '^res_<:comp_itmsk:>{力量的代价,Y,1,1,O,}1^rtype1',
			'itm4' => '技能核心',
			'itmk4' => array('SC02','SCC2','SCB2','SCA2','SCS2'),
			'itme4' => '1',
			'itms4' => '1',
			'itmsk4' => '^res_<:comp_itmsk:>{力量的代价,Y,1,1,O,}1^rtype1',
			'itm5' => '技能核心',
			'itmk5' => array('SC02','SCC2','SCB2','SCA2','SCS2'),
			'itme5' => '1',
			'itms5' => '1',
			'itmsk5' => '^res_<:comp_itmsk:>{力量的代价,Y,1,1,O,}1^rtype1',
			'itm6' => '技能核心',
			'itmk6' => array('SC02','SCC2','SCB2','SCA2','SCS2'),
			'itme6' => '1',
			'itms6' => '1',
			'itmsk6' => '^res_<:comp_itmsk:>{力量的代价,Y,1,1,O,}1^rtype1',
		),
	),
	427 => array(
		'name' => '宝藏猎人',
