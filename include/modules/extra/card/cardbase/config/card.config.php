...
$packdesc = array(
	...
	'Balefire Rekindle' => '以游戏版本「复燃」起新增的角色和游戏设定为主题的卡集，也包含协助测试找BUG的奖励卡。',
...
$cards = array(
	...
	89 => array(
		...
		'pack' => 'Event Bonus',
		'desc' => '富二代的爸爸',
		'effect' => '开局金钱+80并获得技能「理财」，且「理财」效果翻倍',
	...
	164 => array(
		...
		'effect' => '开局金钱+88元，经验、怒气、全熟、歌魂和最大歌魂都增加8',
		'energy' => 88,
		'valid' => array(
			'money' => '+88',
			'exp' => '+8',
	...
	218 => array(
		...
		'desc' => '凭本事借的钱，为什么要还？',
		'effect' => '他因为撸小贷被限制消费了',
		'desc_skills' => '初始金钱+80元，但获取金额时不能超过上限。可以消耗技能点还款来解除限制。',
		'energy' => 0,
		'valid' => array(
		  'money' => '+80',
			'skills' => array(
...
<br>￣^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^￣
	...
	375 => array(
		...
		'desc_skills' => '「封印」：无法行动，达到5分钟或受到其他人的攻击时解除
	...
	405 => array(
		...
		'effect' => '我只知道我要大开杀戒',
		'desc_skills' => '开局全系熟练度+8，但会跳过开局剧情、地点事件和NPC特殊对话的显示',
		'energy' => 0,
		'valid' => array(
			'wp' => '+8',
			'wk' => '+8',
	...
	411 => array(
		...
		'effect' => '任何玩家在触发了你埋设的陷阱之后，有70%几率再次触发同一地点已经存在的一个陷阱',
		'energy' => 100,
		'valid' => array(
			'skills' => array(
				'744' => '1',
	...
	419 => array(
		...
		'desc' => '東埔寨掌管下克上的鬼人',
		'effect' => '管理员，老子反了.jpg',
		'desc_skills' => '攻击使用S卡的玩家时造成伤害+30%，<br>并使对方的操作区在30秒内翻转',
		'energy' => 0,
		'valid' => array(
			'skills' => array(
				'749' => '0',
	...
	420 => array(
		...
		'pack' => 'Event Bonus',
		'desc' => '好，天胡开局',
		'effect' => '开局携带三个梦境演练的开局道具，<br>梦境演练与肉鸽模式中使用该卡片视为属于全部卡包',
		'energy' => 77,
		'valid' => array(
			'skills' => array(
				'750' => '0',
	...
	423 => array(
		...
		'effect' => '你只能记住4个技能，开局全系熟练度为随机0至31',
		'desc_skills' => '生命、攻防、治愈等少数技能不计入总数，称号特性不能被遗忘',
		'energy' => 0,
		'valid' => array(
			'wp' => '+'.rand(0,31),
			'wk' => '+'.rand(0,31),
	...
	424 => array(
		...
		'desc' => '当梦想照进现实',
		'effect' => '你就会发现要迟到了',
		'desc_skills' => '开局获得一个等级1的梦境礼盒，但是开局生命和体力上限-50',
		'energy' => 150,
		'valid' => array(
			'hp' => '-50',
			'mhp' => '-50',
	...
	425 => array(
		...
		'rare' => 'A',
		'pack' => 'Ranmen',
		'desc' => '自来水里含有丰富的微量元素，<br>可以直接饮用',
		'effect' => '开局随机获得一瓶药水，使用后可以临时获得特定属性',
		'energy' => 50,
		'valid' => array(
			'itm6' => '自制药水',
			'itmk6' => 'MB',
			'itme6' => '1',
			'itms6' => '1',
			'itmsk6' => array('^mbid806^mblvl0^mbtime360','^mbid806^mblvl1^mbtime360','^mbid806^mblvl2^mbtime360','^mbid806^mblvl3^mbtime360','^mbid806^mblvl4^mbtime360','^mbid806^mblvl31^mbtime360','^mbid806^mblvl32^mbtime360','^mbid806^mblvl33^mbtime360','^mbid806^mblvl34^mbtime360','^mbid806^mblvl37^mbtime360'),
		),
	),
	426 => array(
		'name' => '亚空神选',
		'rare' => 'S',
		'pack' => 'Ranmen',
		'desc' => '四尊大神伺候着我一个人，<br>这福气还小吗？',
		'effect' => '开局获得四个随机稀有度的技能核心，每个技能核心使用后都会获得一个诅咒道具',
		'energy' => 100,
		'valid' => array(
			'itm3' => '神之祝福',
			'itmk3' => array('SC02','SCC2','SCB2','SCA2','SCS2'),
			'itme3' => '1',
			'itms3' => '1',
			'itmsk3' => '^res_<:comp_itmsk:>{骁勇善战,Y,1,1,O,}1^rtype1',
			'itm4' => '神之祝福',
			'itmk4' => array('SC02','SCC2','SCB2','SCA2','SCS2'),
			'itme4' => '1',
			'itms4' => '1',
			'itmsk4' => '^res_<:comp_itmsk:>{足智多谋,Y,1,1,O,}1^rtype1',
			'itm5' => '神之祝福',
			'itmk5' => array('SC02','SCC2','SCB2','SCA2','SCS2'),
			'itme5' => '1',
			'itms5' => '1',
			'itmsk5' => '^res_<:comp_itmsk:>{生机勃勃,Y,1,1,O,}1^rtype1',
			'itm6' => '神之祝福',
			'itmk6' => array('SC02','SCC2','SCB2','SCA2','SCS2'),
			'itme6' => '1',
			'itms6' => '1',
			'itmsk6' => '^res_<:comp_itmsk:>{风流倜傥,Y,1,1,O,}1^rtype1',
		),
	),
	427 => array(
		'name' => '摸金校尉',
		...
		'pack' => 'Ranmen',
		'desc' => '藏宝图果然又碎了',
		'effect' => '进场时在随机地点刷新一个改造核心·S级，并获得该地点名的模糊提示',
		'energy' => 100,
		'valid' => array(
			'skills' => array(
				'759' => '0',
	...
	428 => array(
		...
		'rare' => 'A',
		'pack' => 'Way of Life',
		'desc' => '偶遇杂技克星强手裂颅强如怪物，拼尽全力无法战胜',
		'effect' => '获得技能「激怒」「重击2」',
		'desc_skills' => '「激怒」：若敌人对你发动了战斗技，你造成的物理伤害永久+20%
		<br>「重击2」：战斗时有25%概率提高物理伤害30%',
		'energy' => 100,
		'valid' => array(
			'skills' => array(
				'760' => '0',
	...
	429 => array(
		...
		'pack' => 'Way of Life',
		'desc' => '🌿✋🐯😡🥶😡🥶😡🥶',
		'effect' => '怒气高于50时造成和受到战斗伤害×2，怒气不高于50时探索体力消耗-12',
		'energy' => 100,
		'valid' => array(
			'skills' => array(
				'761' => '0', 
	...
	431 => array(
		...
		'rare' => 'S',
		'pack' => 'Ranmen',
		'desc' => '本卡集中大部分机制的设计者。<br>小游戏爱好者。',
		'effect' => '开局获得六个小游戏技能',
		'desc_skills' => '「占卜」：可以随时抛硬币和丢骰子（但是没什么用）
		<br>「魔盒」：可以使用一个投入金钱后50%翻倍，50%消失的盒子
		<br>「欺货」：可以在『欺货市场』中买入或卖出特定道具
		<br>「扭蛋」：可以消耗金钱抽取扭蛋道具
		<br>「打牌」：可以与特殊NPC打牌（但是没什么用）
		<br>「钓客」：每60秒可以随机获得一个鱼类（？）物品',
		'energy' => 9,
		'valid' => array(
			'skills' => array(
				'716' => '0',
	...
	432 => array(
		...
		'rare' => 'B',
		'pack' => 'Cyber Zealots',
		'desc' => '使用搜索引擎治疗疑难杂症的专家',
		'effect' => '开局携带笔记本电脑或手机，可以使用笔记本电脑或手机治疗异常状态',
		'desc_skills' => '但有大概率失败，失败时会获得怒气、经验和额外的异常状态',
		'energy' => 0,
		'valid' => array(
			'itm6' => array('笔记本电脑', '手机'),
			'itmk6' => 'X',
	...
	433 => array(
		...
		'pack' => 'Cyber Zealots',
		'desc' => '爱缝手机的忠实用户',
		'effect' => '这边有一个刚好能掉进手机的缝',
		'desc_skills' => '开局携带一份特色合成配方（可学习）：手机 + 名字包含「落穴」的道具 = ★爱缝手机★/歌魂增加/120/1',
		'energy' => 100,
		'valid' => array(
			'itm6' => array('《哈雪大帽险》', '《土鸡土鸡蛋》'),//待补充
			'itmk6' => 'R',
			'itme6' => '1',
			'itms6' => '1',
			'itmsk6' => '59',
	...
	1201 => array(
		...
		'rare' => 'C',
		'pack' => 'Pungeon',
		'desc' => '中杯难度。<br>愿你有个安宁的夜晚。',
		'effect' => '称号固定为走路萌物，<br>初始属性大幅增加<br>（成就计分×1）',
		'desc_skills' => '初始生命上限+200，攻防+300，全系熟练度+100',
		'energy' => 0,
		'valid' => array(
			'club' => '17',
			'hp' => '+200',
	...
	1202 => array(
		...
		'rare' => 'B',
		'pack' => 'Pungeon',
		'desc' => '大杯难度。<br>普通的睡眠质量。',
		'effect' => '称号固定为走路萌物，<br>初始属性小幅增加，没有技能「治愈」<br>（成就计分×2）',
		'desc_skills' => '初始生命上限+100，攻防+100，全系熟练度+50',
		'energy' => 0,
		'valid' => array(
			'club' => '17',
			'hp' => '+100',
	...
	1203 => array(
		...
		'pack' => 'Pungeon',
		'desc' => '超大杯难度。<br>加班受害者。',
		'effect' => '称号固定为走路萌物，<br>没有技能「治愈」，<br>使用补给效果降低，商店价格×1.2<br>（成就计分×4）',
		'desc_skills' => '使用补给效果-30%',
		'energy' => 0,
		'valid' => array(
			'club' => '17',
			'skills' => array(
	...
	1204 => array(
		...
		'rare' => 'S',
		'pack' => 'Pungeon',
		'desc' => '■■■难度。<br><span class="red b">烫烫烫烫烫烫烫</span>',
		'effect' => '称号固定为走路萌物，<br>没有技能「治愈」和「解限」，<br>使用补给效果和造成伤害降低，<br>商店价格×1.25，初始道具减少<br>（成就计分×8）',
		'desc_skills' => '使用补给效果-30%，造成伤害-10%<br>包裹内初始道具只有补给品和梦境礼盒',
		'energy' => 0,
		'valid' => array(
			'club' => '17',
			'skills' => array(
