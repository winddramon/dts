...
//		}
	...
	function parse_card_gaining_method()
	{
		...
		//特判。这里主要是旧版成就和非成就的获得方式，新版成就不用在这里写特判
		$cgmethod[0][] = '注册账号即有';
