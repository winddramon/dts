...
namespace item_randskills
{
	...
	$rs_banlist = array(10,11,12,19,20,24,29,31,39,55,56,59,72,79,83,98,224,231,106);
	//某些技能附带另外的技能，很搞
	$rs_feature = array
	(
		//拆弹称号特性
	...
	$rs_cardskills = array
	(
		'S' => array(405, 406, 415, 434, 500, 515, 516, 564, 591, 708, 719, 755, 756, 985),//518（回归）, 539（不死）
		'A' => array(407, 409, 410, 437, 439, 440, 446, 458, 472, 486, 496, 502, 517, 527, 560, 595, 597, 710, 745, 762),
		'B' => array(416, 420, 429, 443, 447, 453, 454, 464, 465, 467, 473, 534, 556, 567, 590, 598, 705, 723, 728, 731, 738, 741, 753, 761),
	...
	function parse_skcore_skilldesc($skillid)
	{
		...
		$sk_desc_text = array(
			422 => '把枪械当做钝器攻击时伤害不减，且可以正常造成属性伤害',
			...
			570 => '怒气上限为255',
			728 => '获得一个魔盒，可以投入任意数量金钱，有可能翻倍归还也有可能消失',
			747 => '每次行动后有概率唱一首歌',
		...
		//少数没有desc文件的技能
		if(!defined('MOD_SKILL'.$skillid.'_DESC')) return '缺少技能介绍，请联系管理员。';
		ob_start();
