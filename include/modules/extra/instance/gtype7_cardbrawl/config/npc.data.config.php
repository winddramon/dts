	...
	//	),
			...
			(
				...
				(
					...
					'itms3' => 1,
					'itmsk3' => '',
					'description' => '杏仁豆腐 海丽丝，不知从哪里混进幻境的蜜汁游戏制作人，初期对玩家有较大威胁，掉落启动死斗模式的钥匙和一本隐形技能书。',
				),
				1 => array
				(
					'name' => '芙蓉',
					...
					'itms3' => 1,
					'itmsk3' => '',
					'description' => '代码聚合体 芙蓉，亲自上阵的『红杀』隐秘行动课教头……的一个复制品，初期对玩家有较大威胁，掉落启动死斗模式的钥匙和武器强化道具素材。',
				),
			),
		),//END OF TYPE 5
		...
		(
			...
			(
				...
				(
					...
					'arts' => 1,
					'artsk' => 'H',
					'description' => '幻境接待员 GOTHIC，被红暮拉来处理幻境事务的工具人。<span class="yellow b">被击杀后会变身为攻击力极强的NPC</span>。',
				),
				1 => array
				(
					'name' => '特技表演者 JACKPOT',
					'icon' => 'avatar_cz/ga77.png',
					'mss' => 50,
					'wep' => '小丑彩球',
					'wepk' => 'WC',
					'wepe' => 180,
					...
					'arts' => 1,
					'artsk' => 'H',
					'description' => '特技表演者 JACKPOT，幻境中一个来历不明却又特别显眼的志愿表演者。<span class="yellow b">被击杀后会变身为攻击力极强的NPC</span>。',
				),
				2 => array
				(
					'name' => '自律维序者 SANMA',
					'icon' => 'avatar_cz/sanma.png',
					'mss' => 50,
					'wep' => '元素枪刃『Glider』模样的罐头',
					'wepk' => 'WF',
					'wepe' => 140,
					'weps' => 100,
					'wepsk' => 'c',
					...
					'arts' => 1,
					'artsk' => 'H',
					'description' => '自律维序者 SANMA，本应是幻境的维序程序，有些时候却像是活人。<span class="yellow b">被击杀后会变身为攻击力极强的NPC</span>。',
				),
			),
		), //END OF TYPE 14
