...
namespace skill981
{
	...
	$skill981_prizeitems = array(
		...
		1 => array(
			...
			//自定义部分
			array('快说小仓唯唱歌贼！好！听！','ss',100,1,"^hlog_<:comp_itmsk:>{歌词卡片的背面写着一段留言：<span class='cyan b'>“纳西妲女士和蕾薇希雅女士的小脚也很吸引人，但是不同时期喜爱的角色不一样，目前最喜欢的角色是日富美，本来的话这里应该有一段特别长长到页面上限需要翻页才能看见的对阿慈谷日富美小姐以及她的嗨丝的发癫文学，但是由于过于淫秽色情被■■■■驳回了，真是无语。”</span><br><br>}1",1000),//下头
		),
		2 => array(
