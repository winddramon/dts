...
namespace skill981
{
	...
	$skill981_prizeitems = array(
		1 => array(
			...
			array('『破坏之杖』','WD',140,40,'d',5),
			array('★伊吹瓢★','X',1,1,'',5),
			array('小黄的『十万伏特』','WC',251,'∞','cewH',1),
			array('『AK-47』','WG',140,20,'r',5),
			array('游戏王卡包','ygo',1,12,'',2),
			array('《现代游戏王》','ygo2',1,5,'',3),
			array('★连接认证1★','X',1,1,'',2),
			//
			array('『Poini Kune的死库水』','DB',25,10,'Aa',2),
			array('《ACFUN大逃杀攻略》','VV',40,2,'',10),
			array('★技能手册·B级★','VS',1,1,'rdsk_B',20),
			array('★透明卡砖·B级★','VO1',1,1,'card_B',30),
		...
		3 => array(
			...
			array('★技能手册·A级★','VS',1,1,'rdsk_A',20),
			array('★透明卡砖·A级★','VO1',1,1,'card_A',30),
		...
		6 => array(
			...
			array('★技能手册·S级★','VS',1,1,'rdsk_S',15),
			array('★透明卡砖·S级★','VO1',1,1,'card_S',20),
			array('精致的大逃杀卡牌包','VO3',1,3,'',6),
			array('【神经强化剂】','ME',20,20,'',10),
		...
		10 => array(
			...
			array('《魔导百科全书·终》','VF',100,3,'^alt_<:comp_itmsk:>{SC02,SCB2,SCB2,SCB2,SCA2,SCA2,SCA2,SCA2,SCS2,SCS2}1^ahid2',4),
			array('★透明卡砖·S级★','VO1',1,1,'card_S',8),
			array('闪耀的大逃杀卡牌包','VO5',1,2,'',5),
