...
namespace skill981
{
	...
	$skill981_prizeitems = array(
		...
		1 => array(
			...
			//自定义部分
			array('快说小仓唯唱歌贼！好！听！','ss',100,1,"^hlog_<:comp_itmsk:>{歌词卡片的背面写着一段留言：<span class='cyan b'>“纳西妲女士和蕾薇希雅女士的小脚也很吸引人，但是不同时期喜爱的角色不一样，目前最喜欢的角色是日富美，本来的话这里应该有一段特别长长到页面上限需要翻页才能看见的对阿慈谷日富美小姐以及她的嗨丝的发癫文学，但是由于过于淫秽色情被■■■■驳回了，真是无语。”</span><br><br>}1",1),//下头
		),
		2 => array(
		...
		6 => array(
			...
			array('★欧内的手★','DA',888,888,'N^sa8^eqpsk97',1),
		...
		7 => array(
			...
			array('小空','DA',500,150,'CD',2),
			array('真 - 幻想戏服','DB',500,150,'PF',2),
			array('★哇袄★','DB',888,888,'A^sa8^eqpsk89',1),
			array('礼品盒','p',1,15,'',3),
			array('《魔导百科全书·终》','VF',100,2,'^alt_<:comp_itmsk:>{SC02,SCB2,SCB2,SCB2,SCA2,SCA2,SCA2,SCA2,SCS2,SCS2}1^ahid2',3),
			array('★技能手册·S级★','VS',1,1,'rdsk_S',7),
			array('N型技能核心·改','SC01',1,3,'',8),
		...
		9 => array(
			...
			//
			array('★荆棘王冠★','DHS',300,30,'^hu300',5),
			array('★唢呐★','DH',888,888,'v^sa8^eqpsk90',1),
			array('★王♂之逆转★','VS',1,1,'754',5),
