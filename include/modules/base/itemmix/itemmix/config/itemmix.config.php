...
$mixinfo = array
	...
	array('class' => 'wf', 'stuff' => array('声符『枭的夜鸣声』','非常食'),'result' => array('夜盲『夜雀之歌』','WF',30,'∞','wr^alt_<:comp_itmsk:>{ss}1'),),
	array('class' => 'wf', 'stuff' => array('空白符卡','雏人形'),'result' => array('疵符『破裂的护身符』','WF',30,'∞','p'),),
	array('class' => 'wf', 'stuff' => array('疵符『破裂的护身符』','天使玩偶'),'result' => array('创符『流刑人形』','WF',30,'∞','pc^alt_<:comp_itmsk:>{A}1'),),
	array('class' => 'wf', 'stuff' => array('空白符卡','被遗忘的伞'),'result' => array('伞符『雨伞的星之交响』','WF',40,'∞','iN'),),
	array('class' => 'wf', 'stuff' => array('伞符『雨伞的星之交响』','全恢复药剂'),'result' => array('雨伞『超防水干爽伞妖』','WF',40,'∞','iNa^alt_<:comp_itmsk:>{DAS}1'),),
