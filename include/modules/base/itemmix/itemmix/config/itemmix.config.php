...
$mixinfo = array
  ...
  array('class' => 'ocg', 'stuff' => array('「隼骑士」-仮','☆四星认证☆'),'result' => array('「隼骑士」 ★3','WC03',100,'∞','rj'),),
	...
	array('class' => 'ocg', 'stuff' => array('「X-首领加农」-仮','☆四星认证☆'),'result' => array('「X-首领加农」 ★4','WC04',180,'150','i^alt_<:comp_itmsk:>{DA04}1'),),
	...
	array('class' => 'ocg', 'stuff' => array('「V-喷气虎」 ★4','「W-弹射飞翼」 ★4'),'result' => array('「VW-强击虎」 ★6','WC06',200,'∞','pu^alt_<:comp_itmsk:>{DA06,DF06}'),),
	array('class' => 'ocg', 'stuff' => array('「X-首领加农」 ★4','「Y-龙头」 ★4','「Z-金属履带」 ★4'),'result' => array('「XYZ-神龙炮」 ★8','WC08',280,'∞','iew^alt_<:comp_itmsk:>{DH08,DF08}'),),
	array('class' => 'ocg', 'stuff' => array('「VW-强击虎」 ★6','「XYZ-神龙炮」 ★8'),'result' => array('「VWXYZ-神龙强击炮」 ★8','WC08',320,'∞','puiewy^alt_<:comp_itmsk:>{DB08,DH08,DA08,DF08}'),),
	array('class' => 'ocg', 'stuff' => array('「V-喷气虎」 ★4','「W-弹射飞翼」 ★4','「X-首领加农」 ★4','「Y-龙头」 ★4','「Z-金属履带」 ★4'),'result' => array('「VWXYZ-神龙强击炮」 ★8','WC08',450,'∞','puiewy^alt_<:comp_itmsk:>{DB08,DH08,DA08,DF08}'),),
