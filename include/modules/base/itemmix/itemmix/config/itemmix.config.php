...
$mixinfo = array
	(
	array('class' => 'h', 'stuff' => array('杂炊','松茸'),'result' => array('松茸御饭','HS',120,20,),),
	array('class' => 'h', 'stuff' => array('咖喱','面包'),'result' => array('咖喱面包','HH',140,8,),),
	array('class' => 'h', 'stuff' => array('牛奶','立顿茶包','糯米丸子'),'result' => array('珍珠奶茶','HB',270,18,),),
	...
	array('class' => 'wk', 'stuff' => array('西瓜','水果刀','磨刀石'),'result' => array('西瓜刀','WK',99,'∞','ci'),),
	...
	array('class' => 'wk', 'stuff' => array('沾满绿锈的铜刀','『祝福宝石』'),'result' => array('妖刀【飞叶】','WK',52,52,'rpc'), 'tips' => '化解诅咒需以毒攻毒。豪运自然也不可或缺。'),
	...
	array('class' => 'wk', 'stuff' => array('夜刀【月影】','悲叹之种'),'result' => array('疾风刀【里月影】','WK',570,240,'rdc^dfl30'),),
	...
	array('class' => 'wk', 'stuff' => array('夜刀【月影】','《曾伽·宗博尔特自传》'),'result' => array('七星刀【天权】','WK',777,777,'Nnrp^dfl30'),),
	...
	array('class' => 'hidden', 'stuff' => array('冰封的『Oblivion』','火把'),'result' => array('『Oblivion』','WK',300,10,'i'),),
	...
	array('class' => 'wp', 'stuff' => array('『祝福宝石』','『心灵激光鞭』'),'result' => array('萨卡兰姆神圣棍棒','WP',150,140,'Nwcy^dfl20'),),
	array('class' => 'wp', 'stuff' => array('悲叹之种','萨卡兰姆神圣棍棒'),'result' => array('妖邪必败','WP',1540,200,'Nfcy^dfl40'),),
	...
	array('class' => 'wp', 'stuff' => array('『诺基亚3210』[+4]','数据……碎片'),'result' => array('『曾经的荣光-诺基亚』','WP',1865,'∞','NAaR^ac1^alt_<:comp_itmsk:>{A}1Z')),
	array('class' => 'wp', 'stuff' => array('『诺基亚3210』[+4]','数据……碎片','★王家之盾★'),'result' => array('『曾经的荣光-诺基亚』','WP',1865,'∞','NAaR^ac1^wc1^alt_<:comp_itmsk:>{DB}1Z')),
	...
	array('class' => 'd', 'stuff' => array('电磁充能手套','增幅设备','脉冲蓄电池'),'result' => array('电磁脉冲手套','DA',320,160,'Ney'),),
	array('class' => 'd', 'stuff' => array('电磁充能手套','☆钢之精华☆','波动防御护盾'),'result' => array('电磁力场手套','DA',320,160,'aH^hu200'),),
	...
	array('class' => 'item', 'stuff' => array('广域生命探测器','精神界面','某种电子零件'),'result' => array('心灵式生命探测器','ER',1,1,'^rdsk18'),),
	...
	array('class' => 'wf', 'stuff' => array('宝符「陰陽宝玉」','『祝福宝石』'),'result' => array('霊符「夢想封印」','WF',180,'∞','cnd'),),
	...
	array('class' => 'wf', 'stuff' => array('恋符「非定向光线」','《占星术导论》'),'result' => array('恋符「极限火花」','WF',180,'∞','cNf'),), 
	...
	array('class' => 'wf', 'stuff' => array('星符『星尘狂欢』','蘑菇','幻之使魔'),'result' => array('妖器「黑暗火花」','WGF',200,180,'uf^eqpsk465'),),
	array('class' => 'wf', 'stuff' => array('时符『Private Square』','『永恒的温柔』','幻之使魔'),'result' => array('妖器「银色异次元」','WCF',200,180,'ik^eqpsk273'),),
	...
	array('class' => 'wf_pn', 'stuff' => array('土符「Lazy Trilithon」','水符「Princess Undine」','空白符卡'),'result' => array('土&水符『Noachian Deluge』','WF',220,'∞','ic'),),
	...
	array('class' => 'ut', 'stuff' => array('空白符卡','怨灵','走失的猫咪'),'result' => array('猫符「怨灵猫乱步」','WF',99,'∞','up'),),
	...
	array('class' => 'ut', 'stuff' => array('空白符卡','广域生命探测器','精神制剂'),'result' => array('想起「恐怖催眠术」','WF',80,100,'cd'),),
	array('class' => 'ut', 'stuff' => array('空白符卡','小五拖鞋'),'result' => array('想起「恐怖催眠术」','WF',90,'∞','cd'),),
	array('class' => 'ut', 'stuff' => array('想起「恐怖催眠术」','鬼火『超高密度燐祸术』'),'result' => array('想起「户隐山之投」','WF',150,'∞','cf'),),
	array('class' => 'ut', 'stuff' => array('想起「户隐山之投」','☆博丽护符☆','造雾设备'),'result' => array('想起「蒙蒙迷雾」','WF',400,'∞','cfa'),),
	array('class' => 'ut', 'stuff' => array('想起「恐怖催眠术」','风符『风神一扇』'),'result' => array('想起「风神木叶隐身术」','WF',230,'∞','cd'),),
	array('class' => 'ut', 'stuff' => array('想起「风神木叶隐身术」','☆守矢神签☆','『延展御柱』','蛙符【操控群蛙】'),'result' => array('想起「鸟居旋风」','WF',230,'∞','ctr'),),
	array('class' => 'ut', 'stuff' => array('想起「恐怖催眠术」','蓝色方块','金色方块'),'result' => array('想起「Mercury Poison」','WF',94,'∞','cpa'),),
	array('class' => 'ut', 'stuff' => array('想起「Mercury Poison」','红色方块','绿色方块','黄色方块'),'result' => array('想起「贤者之石」','WF',500,'∞','cuipwe'),),
	array('class' => 'ut', 'stuff' => array('想起「蒙蒙迷雾」','想起「鸟居旋风」','想起「贤者之石」'),'result' => array('想起「朦胧记忆中的金阁寺」','WF',55555,'∞','cyfkt'),),
	array('class' => 'ut', 'stuff' => array('空白符卡','岩石','精神制剂','☆残页的魔导书☆'),'result' => array('表象「弹幕偏执症」','WF',100,514,'nNZ'),),
	array('class' => 'ut', 'stuff' => array('圣石之种','黑蔷薇龙 ★7','黑色方块'),'result' => array('「黑色花园」','A',1,1,'Ac'),),
	array('class' => 'ut', 'stuff' => array('微小日常之爱恋','寂寞','『祝福宝石』'),'result' => array('复燃「恋爱的埋火」','DH',1,1,'B'),),
	array('class' => 'ut', 'stuff' => array('表象「弹幕偏执症」','「黑色花园」','复燃「恋爱的埋火」'),'result' => array('「带刺的蔷薇园」','WFC',233,'∞','rdnN'),),
	array('class' => 'ut', 'stuff' => array('想起「恐怖催眠术」','表象「弹幕偏执症」[+5]','空想爆弹 ~ 出乎意料'),'result' => array('本能「本我的解放」','WF',514,'∞','rnNL'),),
	...
	array('class' => 'ocg', 'stuff' => array('「V-喷气虎」-仮','☆四星认证☆'),'result' => array('「V-喷气虎」 ★4','WC04',160,'180','p^alt_<:comp_itmsk:>{A04}1'),),
	array('class' => 'ocg', 'stuff' => array('「W-弹射飞翼」-仮','☆四星认证☆'),'result' => array('「W-弹射飞翼」 ★4','WC04',130,'150','u^alt_<:comp_itmsk:>{DB04}1'),),
	array('class' => 'ocg', 'stuff' => array('「X-首领加农」-仮','☆四星认证☆'),'result' => array('「X-首领加农」 ★4','WC04',180,'150','i^alt_<:comp_itmsk:>{DH04}1'),),
	array('class' => 'ocg', 'stuff' => array('「Y-龙头」-仮','☆四星认证☆'),'result' => array('「Y-龙头」 ★4','WC04',150,'160','e^alt_<:comp_itmsk:>{DA04}1'),),
	array('class' => 'ocg', 'stuff' => array('「Z-金属履带」-仮','☆四星认证☆'),'result' => array('「Z-金属履带」 ★4','WC04',150,'130','w^alt_<:comp_itmsk:>{DF04}1'),),
	array('class' => 'ocg', 'stuff' => array('「V-喷气虎」 ★4','「W-弹射飞翼」 ★4'),'result' => array('「VW-强击虎」 ★6','WC06',200,'∞','pu^alt_<:comp_itmsk:>{DB06,DH06}1'),),
	array('class' => 'ocg', 'stuff' => array('「X-首领加农」 ★4','「Y-龙头」 ★4','「Z-金属履带」 ★4'),'result' => array('「XYZ-神龙炮」 ★8','WC08',280,'∞','iew^alt_<:comp_itmsk:>{DA08,DF08}1'),),
	...
	array('class' => 'ocg', 'stuff' => array('「真紅眼黑龍」-仮','☆七星认证☆'),'result' => array('「真紅眼黑龍」 ★7','WC07',240,'∞','cuN'),),
  ...
  array('class' => 'ocg', 'stuff' => array('「电子终结龙」 ★10','「电子终结龙」 ★10','「电子终结龙」 ★10'),'result' => array('「电子天龙头」 ★10','WC10',1200,'∞','ZNnrc'),),
	...
	array('class' => 'ocg', 'stuff' => array('武器手套 ★4 -仮','☆四星认证☆'),'result' => array('武器手套 ★4','DAS04',180,120,'c^001'),),
	array('class' => 'ocg', 'stuff' => array('甲化铠骨骼 ★6 -仮','☆六星认证☆'),'result' => array('甲化铠骨骼 ★6','DBS06',250,160,'GD^001'),),
	array('class' => 'ocg', 'stuff' => array('英豪冠军 草雉剑王','《曾伽·宗博尔特自传》'),'result' => array('英♂豪冠军 断♂肛♂剑♂王 ☆4','WK',444,'∞','Znd^xyz4'),),
	array('class' => 'ocg', 'stuff' => array('始祖守护者 提拉斯 ☆5 -仮','☆五星认证☆'),'result' => array('始祖守护者 提拉斯 ☆5','WC',260,'∞','fwi^xyz5'),),
	...
	array('class' => 'ocg', 'stuff' => array('红莲魔龙 ★8','☆爆裂模式☆'),'result' => array('真红魔龙/爆裂体 ★10','WC10',300,'∞','dZ'),),
	...
	array('class' => 'ocg', 'stuff' => array('「效果遮蒙者」 ★1-仮','☆手坑认证☆'),'result' => array('「效果遮蒙者」 ★1','WC01',0,'∞','Bs'),),
	array('class' => 'ocg', 'stuff' => array('「幽鬼兔」 ★3-仮','☆手坑认证☆'),'result' => array('「幽鬼兔」 ★3','WC03',50,'∞','dbs'),),
	...
	array('class' => 'hidden', 'stuff' => array('红色方块','Y方块'),'result' => array('金色方块','X',1,1,),),
	array('class' => 'hidden', 'stuff' => array('红色方块','Y方块'),'result' => array('黑色方块','X',1,1,),),
	array('class' => 'hidden', 'stuff' => array('金色方块','Y方块'),'result' => array('红色方块','X',1,1,),),
	array('class' => 'hidden', 'stuff' => array('金色方块','Y方块'),'result' => array('黑色方块','X',1,1,),),
	array('class' => 'hidden', 'stuff' => array('黑色方块','Y方块'),'result' => array('红色方块','X',1,1,),),
	array('class' => 'hidden', 'stuff' => array('黑色方块','Y方块'),'result' => array('金色方块','X',1,1,),),
	array('class' => 'hidden', 'stuff' => array('绿色方块','Y方块'),'result' => array('黄色方块','X',1,1,),),
	array('class' => 'hidden', 'stuff' => array('绿色方块','Y方块'),'result' => array('白色方块','X',1,1,),),
	array('class' => 'hidden', 'stuff' => array('黄色方块','Y方块'),'result' => array('绿色方块','X',1,1,),),
	array('class' => 'hidden', 'stuff' => array('黄色方块','Y方块'),'result' => array('白色方块','X',1,1,),),
	array('class' => 'hidden', 'stuff' => array('白色方块','Y方块'),'result' => array('绿色方块','X',1,1,),),
	array('class' => 'hidden', 'stuff' => array('白色方块','Y方块'),'result' => array('黄色方块','X',1,1,),),
	array('class' => 'hidden', 'stuff' => array('蓝色方块','Y方块'),'result' => array('银色方块','X',1,1,),),
	array('class' => 'hidden', 'stuff' => array('蓝色方块','Y方块'),'result' => array('水晶方块','X',1,1,),),
	array('class' => 'hidden', 'stuff' => array('银色方块','Y方块'),'result' => array('蓝色方块','X',1,1,),),
	array('class' => 'hidden', 'stuff' => array('银色方块','Y方块'),'result' => array('水晶方块','X',1,1,),),
	array('class' => 'hidden', 'stuff' => array('水晶方块','Y方块'),'result' => array('蓝色方块','X',1,1,),),
	array('class' => 'hidden', 'stuff' => array('水晶方块','Y方块'),'result' => array('银色方块','X',1,1,),),
	array('class' => 'hidden', 'stuff' => array('红色方块','X方块'),'result' => array('绿色方块','X',1,1,),),
	array('class' => 'hidden', 'stuff' => array('红色方块','X方块'),'result' => array('蓝色方块','X',1,1,),),
	array('class' => 'hidden', 'stuff' => array('绿色方块','X方块'),'result' => array('红色方块','X',1,1,),),
	array('class' => 'hidden', 'stuff' => array('绿色方块','X方块'),'result' => array('蓝色方块','X',1,1,),),
	array('class' => 'hidden', 'stuff' => array('蓝色方块','X方块'),'result' => array('红色方块','X',1,1,),),
	array('class' => 'hidden', 'stuff' => array('蓝色方块','X方块'),'result' => array('绿色方块','X',1,1,),),
	array('class' => 'hidden', 'stuff' => array('金色方块','X方块'),'result' => array('黄色方块','X',1,1,),),
	array('class' => 'hidden', 'stuff' => array('金色方块','X方块'),'result' => array('银色方块','X',1,1,),),
	array('class' => 'hidden', 'stuff' => array('黄色方块','X方块'),'result' => array('金色方块','X',1,1,),),
	array('class' => 'hidden', 'stuff' => array('黄色方块','X方块'),'result' => array('银色方块','X',1,1,),),
	array('class' => 'hidden', 'stuff' => array('银色方块','X方块'),'result' => array('金色方块','X',1,1,),),
	array('class' => 'hidden', 'stuff' => array('银色方块','X方块'),'result' => array('黄色方块','X',1,1,),),
	array('class' => 'hidden', 'stuff' => array('黑色方块','X方块'),'result' => array('白色方块','X',1,1,),),
	array('class' => 'hidden', 'stuff' => array('黑色方块','X方块'),'result' => array('水晶方块','X',1,1,),),
	array('class' => 'hidden', 'stuff' => array('白色方块','X方块'),'result' => array('黑色方块','X',1,1,),),
	array('class' => 'hidden', 'stuff' => array('白色方块','X方块'),'result' => array('水晶方块','X',1,1,),),
	array('class' => 'hidden', 'stuff' => array('水晶方块','X方块'),'result' => array('黑色方块','X',1,1,),),
	array('class' => 'hidden', 'stuff' => array('水晶方块','X方块'),'result' => array('白色方块','X',1,1,),),
